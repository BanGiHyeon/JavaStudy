 ...
 *                         | 스프링 => 디자인 패턴 / 알고리즘 
 *                       => Object clone() throws CloneSupportException
 *                         ------- 1.예외처리 , 2.형변환을 한다 
 *                       => 1.원형 (리턴형 , 메소드명 , 매개변수)
 *                          2.사용처
 ...
 *          ceil(165/10.0) => 16.0
 *          ===> Math는 메소드가 static으로 되어 있다
 *          Math.ceil...
 *         Thread : 한개 프로그램안에 여러개의 프로그램을 동시에 실행
 *         ------ 게임 (시분할)
