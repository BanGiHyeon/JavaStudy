 ...
 *                         ----------- clss 파일 생성
 *               => 주의점
 *                  파일명과 클래스 명이 반드시 동일해야 사용이 가능
 *                  대소문자를 구분한다
 *                  => 언어 (대소문자를 구분한다)
 *                 문법사항은 아니고 약속 
 *              => 클래스 명은 첫 자를 대문자 , 새로운 단어 결합 첫자를 대문자
 *              --------------------------- 헝거리 언식 표현법
 *              => 변수, 메소드 ===> 소문자
 *                 상수 => 전체를 대문자
 *              => {}
 ...
 *              class A  ==> 클래스 시작
 *              { 
 *                     public statci void main(String[] arg) => 메인 시작
 *                     { 
 *                          Systm.out.println("Hello"); 화면출력
 *                     } => 메인 종료
 *                   } 클래스 종료      
 */    
